...
import com.easyfund.constant.LoansConstants;
import com.easyfund.dto.ErrorResponseDto;
import com.easyfund.dto.LoansContactDto;
import com.easyfund.dto.LoansDto;
import com.easyfund.dto.ResponseDto;
import com.easyfund.service.ILoansService;
...
public class LoansController {
    ...
    @GetMapping("/fetch")
    public ResponseEntity<LoansDto> fetchLoanDetails(@RequestHeader("easyfund-correlation-id") String correlationId,
                                                     @RequestParam
                                                     @Pattern(regexp="(^$|[0-9]{10})",message = "Mobile number must be 10 digits")
                                                     String mobileNumber) {
    ...
    @Operation(
            summary = "Fetch Build version of Loan services",
            description = "REST API to fetch loan details build version"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            summary = "Fetch Environment details of Loan services",
            description = "REST API to fetch environment details"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
